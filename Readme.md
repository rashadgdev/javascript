...
- [11.1 Sets and Maps](#111-sets-and-maps)
    - [11.1.1 The Set Class](#1111-the-set-class)
    - [11.1.2 The Map Class](#1112-the-map-class)
    - [11.1.3 WeakMap and WeakSet](#1113-weakmap-and-weakset)
- [11.2 Typed Arrays and Binary Data](#112-typed-arrays-and-binary-data)
    - [11.2.1 Typed Array Types](#1121-typed-array-types)
    - [11.2.2 Creating Typed Arrays](#1122-creating-typed-arrays)
    - [11.2.3 Typed Array Methods](#1123-typed-array-methods)
    - [11.2.4 ArrayBuffer](#1124-arraybuffer)
    - [11.2.5 Binary Data with DataView](#1125-binary-data-with-dataview)
- [11.3 Strings and Regular Expressions](#113-strings-and-regular-expressions)
    - [11.3.1 String Methods](#1131-string-methods)
    - [11.3.2 Regular Expressions](#1132-regular-expressions)
- [11.4 The Date Object](#114-the-date-object)
- [11.5 Error Handling](#115-error-handling)
    - [11.5.1 Error Types](#1151-error-types)
    - [11.5.2 Error Handling with try/catch](#1152-error-handling-with-trycatch)
    - [11.5.3 Throwing Errors](#1153-throwing-errors)
...
- [16. Server-Side JavaScript with Node](#16-server-side-javascript-with-node)
...
- [17. JavaScript Tools and Extensions](#17-javascript-tools-and-extensions)
